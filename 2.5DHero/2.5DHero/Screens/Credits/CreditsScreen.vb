Public Class CreditsScreen
    ...
    Private Sub InitializeCreditsPages(ByVal ending As String)
        ...
        CreditsPages.Add(New CreditsPage("Open Source Development Team", Color.White, Color.Black, {"Benjamin Smith", """Aragas""", """oXFantaXo""", "Jorge Luis Espinoza", "Conner Joseph Brewster", """OmegaGhost""", """SomeKitten"""}.ToList()))
